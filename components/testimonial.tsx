...
export const Testimonial = ({ testimonial }: Props) => {
  return (
    <div className="flex flex-col justify-between max-w-md py-4 px-8 bg-white shadow-lg rounded-lg my-12">
      <div>
        <div className="flex justify-center md:justify-end -mt-16">
          <img
            className="w-20 h-20 object-cover rounded-full border-2 border-secondary bg-secondary"
            src={testimonial.image?.url || "/img/logo_small.png"}
          />
        </div>
        <div>
